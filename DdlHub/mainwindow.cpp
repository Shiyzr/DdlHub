    ...
    , ui(new Ui::MainWindow)
{
    ...
    // 添加成就内容
    零点冲刺王 = new AchievementWidget("零点冲刺王", "你的速度就是你的武器，冲刺时刻从不掉链子！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    零点冲刺王->setConditionText("任务在截止当天的最后2小时内完成");
    早鸟先锋 = new AchievementWidget("早鸟先锋", "早起的鸟儿有虫吃，提前完成让你领先一步！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    早鸟先锋->setConditionText(" 任务至少提前3天完成");
    专注达人 = new AchievementWidget("专注达人", "25分钟的专注，打造出无坚不摧的意志力！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    专注达人->setConditionText("累计完成50个番茄钟专注时长");
    初出茅庐 = new AchievementWidget("初出茅庐", "你的征途，从第一个任务开始，未来无可限量！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    初出茅庐->setConditionText("添加第一个DDL任务");
    夜猫子 = new AchievementWidget("夜猫子", "黑夜是你的战场，灵感在星光下闪耀！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    夜猫子->setConditionText("在午夜至凌晨4点间完成任务");
    百战百胜 = new AchievementWidget("百战百胜", " 百次出击，百次凯旋，你是名副其实的任务终结者！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    百战百胜->setConditionText("累计完成100个任务");
    长期规划师 = new AchievementWidget("长期规划师", "眼光看得远，计划布得深，你是未来的掌舵人！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
    长期规划师->setConditionText("添加一个截止日期在3个月后的任务");
    小试牛刀 = new AchievementWidget("小试牛刀", "10个任务轻松搞定，实力不容小觑！", QPixmap("../../trophy").scaled(40, 40, Qt::KeepAspectRatio, Qt::SmoothTransformation));
